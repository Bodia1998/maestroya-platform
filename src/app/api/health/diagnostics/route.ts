 ...
 * files. This endpoint always returns 200 (its purpose is visibility,
 * not gating traffic/orchestration — same "operational visibility only"
 * category `/api/health/ready`'s own `checks.*` fields already
 * establish, applied to the whole response here rather than to
