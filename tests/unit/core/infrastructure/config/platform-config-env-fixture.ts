...
export function buildTestEnv(overrides: Partial<Env> = {}): Env {
  const base: Env = {
    ...
    FRAUD_DEVICE_FINGERPRINT_PROVIDER: "null",
    FINGERPRINTJS_SECRET_API_KEY: undefined,
    FINGERPRINTJS_REGION: "eu",
    FINGERPRINTJS_TIMEOUT_MS: 5_000,
    FRAUD_VPN_PROXY_PROVIDER: "null",
    IPQS_API_KEY: undefined,
    IPQS_TIMEOUT_MS: 4_000,
    FRAUD_PHONE_REPUTATION_PROVIDER: "null",
    TWILIO_LOOKUP_TIMEOUT_MS: 5_000,
    ...
    GDPR_CLOUDINARY_PURGE_RETRY_BATCH_SIZE: 50,
    GDPR_CLOUDINARY_PURGE_MAX_ATTEMPTS: 8,
    GDPR_CLOUDINARY_PURGE_BASE_DELAY_SECONDS: 60,
    GDPR_CLOUDINARY_PURGE_SCHEDULE_CRON: "*/30 * * * *",
